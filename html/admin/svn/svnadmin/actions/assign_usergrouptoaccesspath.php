...
if (is_array($selusers) && count($selusers) == 1 && empty($selusers[0]))
  $selusers = NULL;
if (is_array($selgroups) && count($selgroups) == 1 && empty($selgroups[0]))
  $selgroups = NULL;
if (is_array($selpaths) && count($selpaths) == 1 && empty($selpaths[0]))
  $selpaths = NULL;
